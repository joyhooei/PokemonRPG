...
{
	JniMethodInfo t;
	if (JniHelper::getStaticMethodInfo(t, "org/cocos2dx/javascript/AndroidUtils", "copyToPasteBoard", "(Ljava/lang/String;)V")) 
	{
...
{
	JniMethodInfo t;
	if (JniHelper::getStaticMethodInfo(t, "org/cocos2dx/javascript/AndroidUtils", "getCurrentUsedMemory", "()D")) 
	{
...
{
	JniMethodInfo t;
	if (JniHelper::getStaticMethodInfo(t, "org/cocos2dx/javascript/AndroidUtils", "checkNetStatus", "()I")) 
	{
